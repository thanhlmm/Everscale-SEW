...
```shell
git clone git@github.com:EverscaleGuild/Everscale-SEW.git
cd Everscale-SEW
git checkout -b feature/name-of-feature origin/main
```

Coding and testing local see [README.md Develop](https://github.com/EverscaleGuild/Everscale-SEW/blob/main/README.md#develop)
...
```shell
https://github.com/EverscaleGuild/Everscale-SEW/pull/new/feature/name-of-feature
```
